...
.row{
  box-shadow:2px 2px 5px skyblue;
  /* background-image:url("/imageBcaStudyBuddy.png");
  background-color: */
  /* background:pink; */
...
<div class="row">
    <div class="col-lg-6">
      <span class="logo">BcaStudyBuddy</span>
      <span class="tagline">A BCA Study Preparation Guide</span>
    </div>
